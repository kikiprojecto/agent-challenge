import { w as withoutTrailingSlash, N as NoSuchModelError, p as parseProviderOptions, a as postJsonToApi, c as combineHeaders, T as TooManyEmbeddingValuesForCallError, U as UnsupportedFunctionalityError, I as InvalidPromptError, b as createJsonResponseHandler, d as createJsonStreamResponseHandler, e as createJsonErrorResponseHandler, g as generateId, f as InvalidResponseDataError } from './index2.mjs';
import { o as object, b as boolean, s as string, n as number, a as array, r as record, c as any, u as union } from './schemas.mjs';

// src/ollama-provider.ts
var ollamaErrorDataSchema = object({
  error: object({
    message: string(),
